...
ON journey_locations (journey_id);CREATE TABLE IF NOT EXISTS journeys (
    id SERIAL PRIMARY KEY,
    driver_id INTEGER NOT NULL,
...
\i src/sql/journey_locations.sql
\i src/sql/notifications.sql
\i src/sql/student_boarding.sql
\i src/sql/student_dropoff.sql
\i src/sql/journey_events.sql
\i src/sql/parent_students.sqlCREATE TABLE IF NOT EXISTS notifications (
    id SERIAL PRIMARY KEY,
    journey_id INTEGER NOT NULL,
    user_id INTEGER,
    student_id INTEGER,
...
ON notifications (journey_id);CREATE TABLE IF NOT EXISTS parent_students (
    id SERIAL PRIMARY KEY,
